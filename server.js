// server.js - исправленная версия с улучшенной работой звонков
...
const server = http.createServer((req, res) => {
  res.setHeader("Access-Control-Allow-Origin", "https://fire-cat-chat-277.netlify.app");
  ...
  ws.on("message", async (data) => {
    ...
    try {
      switch (message.type) {
        ...
        // WebRTC сигнальные сообщения - ИСПРАВЛЕННЫЕ
        case "create_room":
